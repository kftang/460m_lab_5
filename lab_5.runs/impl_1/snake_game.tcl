...
set rc [catch {
  ...
  add_files -quiet C:/Users/Kenny/Programming/Verilog/lab_5/lab_5.runs/synth_1/snake_game.dcp
  read_xdc C:/Users/Kenny/Programming/Verilog/lab_5/lab_5.srcs/constrs_1/new/Basys3_Master.xdc
  link_design -top snake_game -part xc7a35tcpg236-1
...
set rc [catch {
  ...
  write_bitstream -force snake_game.bit 
  catch {write_debug_probes -quiet -force snake_game}
  catch {file copy -force snake_game.ltx debug_nets.ltx}
