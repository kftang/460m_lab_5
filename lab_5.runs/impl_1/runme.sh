...
HD_PWD='C:/Users/Kenny/Programming/Verilog/lab_5/lab_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyboard_interface.tcl -notrace
